            ...
            <div className="flex flex-1 flex-col gap-[30px] items-start justify-start w-full">
              ...
              <div className="bg-white-A700 flex flex-col items-center justify-start p-[120px] md:px-10 sm:px-5 rounded-md shadow-bs w-full">
                <Img
                  ...
                  src="images/img_illustration_indigo_700.svg"
                  alt="illustration"
                />
                <Text
                  className="mt-[26px] text-center text-gray-900_01 text-xl"
                  size="txtInterBold20"
                >
                  Create First Category
                </Text>
                <Text
                  className="leading-[24.00px] mt-3 text-base text-blue_gray-600 text-center"
                  size="txtInterRegular16"
                >
                  <>
                    Organize all your items in stock by creating and adding them
                    to categories.
                    <br />
                    Categories helps to find items faster for your customers.
                  </>
                </Text>
                <div className="bg-blue-A700 flex mt-6 p-2 relative rounded w-1/5">
                  <Img
                  ...
                  />
                  <Text
                    className="ml-[-51px] mr-3 mt-auto text-base text-white-A700 z-[1]"
...
export default CategoriesemptyPage;
