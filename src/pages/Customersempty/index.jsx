            ...
            <div className="flex flex-1 flex-col gap-8 items-start justify-start w-full">
              ...
              <div className="bg-white-A700 flex flex-col items-center justify-start p-[120px] md:px-10 sm:px-5 rounded-md shadow-bs w-full">
                <Img
                  ...
                  src="images/img_illustration_indigo_700_140x140.svg"
                  alt="illustration"
                />
                <Text
                  className="mt-6 text-center text-gray-900_01 text-xl"
                  size="txtInterBold20"
                >
                  Add First Customer
                </Text>
                <Text
                  className="leading-[24.00px] mt-3.5 text-base text-blue_gray-600 text-center"
                ...
                <div className="bg-blue-A700 flex mt-6 p-2 relative rounded w-[21%]">
                  <Img
                  ...
                  />
                  <Text
                    className="ml-[-51px] mr-[13px] my-auto text-base text-white-A700 z-[1]"
